...
export default function SaltWaterFishPage() {
    const data = [
        ...
        {id: 4, image: '/Images/Marine/ClownFish.jpg', name: 'ClownFish'},
        {id: 5, image: '/Images/Marine/CrabFish.jpg', name: 'CrabFish'},
        {id: 6, image: '/Images/Marine/Cucumber.jpg', name: 'Cucumber'},
        {id: 7, image: '/Images/Marine/Damsel.jpg', name: 'Damsel'},
        {id: 8, image: '/Images/Marine/Eals.jpg', name: 'Eals'},
        {id: 9, image: '/Images/Marine/Gobies.jpg', name: 'Gobies'},
        {id: 10, image: '/Images/Marine/Grouper-Snapper.jpg', name: 'Grouper-Snapper'},
        {id: 11, image: '/Images/Marine/HawkFish.jpg', name: 'HawkFish'},
        {id: 12, image: '/Images/Marine/Puffers.jpg', name: 'Puffers'},
        {id: 13, image: '/Images/Marine/RockFish.jpg', name: 'RockFish'},
        {id: 14, image: '/Images/Marine/Shark.jpg', name: 'Shark'},
        {id: 15, image: '/Images/Marine/Shrimp.jpg', name: 'Shrimp'},
        {id: 16, image: '/Images/Marine/Slug.jpg', name: 'Slug'},
        {id: 17, image: '/Images/Marine/StarFish.jpg', name: 'StarFish'},
        {id: 18, image: '/Images/Marine/Surgeon.jpg', name: 'Surgeon'},
        {id: 19, image: '/Images/Marine/Triggers.jpg', name: 'Triggers'},
        {id: 20, image: '/Images/Marine/Urchin.jpg', name: 'Urchin'},
        {id: 21, image: '/Images/Marine/Wrasse.jpg', name: 'Wrasse'},
    ];
