...
type Video = {
    ...
    description: string;
    date: string;
    facility: "fresh" | "marine";
};

const staticVideos: Video[] = [
    { id: 1, fileUrl: "/Videos/VID1.mp4", name: "Our New Facility Stay connected to global career opportunities anytime, anywhere.", description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed ornare nisi est, in euismod ex varius ac. Nullam mattis sodales dolor eget mollis. Cras ut libero ante. Donec iaculis aliquet erat. Sed dignissim cursus quam, non tincidunt nibh pulvinar eu leo.", date: "2025-11-26", facility: "fresh", },
    { id: 2, fileUrl: "/Videos/VID2.mp4", name: "Fresh Water Facility", description: "We have a large collection of fresh water images including number of colors.", date: "2025-11-18", facility: "fresh", },
    { id: 3, fileUrl: "/Videos/VID3.mp4", name: "Salt Water Fish Facility", description: "We have a number of collection of salt water fish / marine fish gallery", date: "2025-11-18", facility: "fresh", },
];

export default function FacilityVideosPage() {
    const [searchQuery, setSearchQuery] = useState("");
    const [expandedId, setExpandedId] = useState<number | null>(null);

    const filteredVideos = staticVideos.filter(
        (video) =>
    ...
    const totalCount = staticVideos.length;
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-accent-900 via-primary-900 to-accent-900 p-4 md:p-8 relative overflow-hidden">
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-primary-400/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "2s" }}></div>
            </div>
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-6 mb-6 border border-white/20 shadow-2xl">
                    ...
                    <div className="mt-4 text-sm text-primary-200">
                        Showing{" "}
                        <span className="font-bold text-primary-300">{videoCount}</span>{" "}
                        of <span className="font-bold text-primary-300">{totalCount}</span>{" "}
                        items
                    </div>
                </div>
                ...
                <div className="mb-8">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h2 className="text-3xl font-bold text-white">Video Gallery</h2>
                    ...
                    {filteredVideos.length === 0 ? (
                        <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-12 border border-white/20 shadow-2xl text-center">
                            ...
                            <p className="text-primary-300">
                                {searchQuery ? "Try adjusting your search query" : "Start by adding your first video"}
                            </p>
                        </div>
                    ) : (
